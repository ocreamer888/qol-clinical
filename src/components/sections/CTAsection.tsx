  ...
  return (
    <section className="bg-[#f8f8f8] py-20 lg:py-28">
      <div className="flex flex-col md:flex-row justify-center items-center max-w-[1237px] bg-[#dad2c7] rounded-[40px] mx-auto lg:pl-12 gap-4">
        <div className="relative flex flex-col items-start justify-center z-10 p-16 lg:p-16 w-full md:w-1/2 max-w-[700px] bg-[#dad2c7] rounded-[40px] gap-4 flex-1">
          ...
          <WhatsAppButton
            ...
            className="flex rounded-full border border-white/45 bg-[#28574e] hover:border-white/70 w-1/2 items-center justify-center backdrop-blur px-4 py-4 text-sm text-white md:px-[12px] md:text-[16px] md:leading-snug"
          >
            Consulta Gratis
          </WhatsAppButton>
        </div>
